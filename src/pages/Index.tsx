...
const Index = () => {
  ...
  return <main className="min-h-screen bg-background">
        ...
        <div className="container relative z-10 px-4 py-20">
          <div className="grid lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
            <div className="text-center lg:text-left space-y-8">
              ...
              duration: 0.7
            }} className="text-5xl md:text-7xl font-bold text-primary" style={{
                ...
                <div className="flex flex-col sm:flex-row gap-4 w-full lg:w-auto">
                  <div className="flex flex-col gap-2">
                    ...
                    scale: 0.95
                      ...
                      <Button onClick={() => openModal("audit")} className="h-16 px-6 text-base font-bold bg-primary text-primary-foreground hover:bg-primary/90 border-2 border-primary transition-all" style={{
                    ...
                    <p className="text-xs text-muted-foreground text-center">Stop losing plants to pests & disease. Get a custom action plan in to Elevate your Operations with AI.</p>
                  </div>
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    scale: 0.95
                      ...
                      <Button onClick={() => openModal("custom")} className="h-16 px-6 text-base font-bold bg-secondary text-secondary-foreground hover:bg-secondary/90 border-2 border-secondary transition-all" style={{
        ...
        <div className="container px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
            ...
            once: true
              ...
              duration: 0.8
            }} className="text-4xl md:text-5xl font-bold text-primary" style={{
              textShadow: 'var(--glow-cyan)'
            }}>
            ...
            once: true
              ...
              duration: 0.3
            }} className="aspect-square rounded-xl bg-gradient-to-br from-primary/10 via-secondary/10 to-accent/10 p-8 flex items-center justify-center border border-primary/30" style={{
              boxShadow: 'var(--glow-cyan)'
            }}>
                <div className="text-center space-y-4">
                  ...
                  ease: "easeInOut"
                    ...
                    <TrendingUp className="w-24 h-24 mx-auto text-primary" style={{
      ...
      <section className="py-20 bg-gradient-to-b from-background to-card/30">
        <div className="container px-4">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            <h2 className="text-4xl md:text-5xl font-bold text-secondary" style={{
      ...
      <section className="py-20 bg-card/50 border-t border-border">
        <div className="container px-4">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <h2 className="text-4xl md:text-5xl font-bold text-primary" style={{
            textShadow: 'var(--glow-cyan)'
          }}>
      ...
      <ContactModal open={isModalOpen} onOpenChange={setIsModalOpen} buttonType={modalType} />
    </main>;
};
